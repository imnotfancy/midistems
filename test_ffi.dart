...
void main() {
  ...
  final initializeAudioEngine = dylib
      .lookupFunction<InitializeAudioEngineFunc, InitializeAudioEngineFunc>(
          'initialize_audio_engine');
  
  final cleanupAudioEngine = dylib
      .lookupFunction<CleanupAudioEngineFunc, CleanupAudioEngineFunc>(
          'cleanup_audio_engine');
  
  final getLastErrorMessage = dylib
      .lookupFunction<GetLastErrorMessageFunc, GetLastErrorMessageFunc>(
          'get_last_error_message');
  
  final freeString = dylib
      .lookupFunction<FreeStringFunc, FreeStringFunc>(
          'free_string');
